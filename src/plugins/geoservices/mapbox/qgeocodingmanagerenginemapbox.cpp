...
QGeoCodeReply *QGeoCodingManagerEngineMapbox::geocode(const QString &address, int limit, int offset, const QGeoShape &bounds)
{
    ...
    QGeoCodeReplyMapbox *geocodeReply = new QGeoCodeReplyMapbox(reply, this);
...
QGeoCodeReply *QGeoCodingManagerEngineMapbox::reverseGeocode(const QGeoCoordinate &coordinate,
...
void QGeoCodingManagerEngineMapbox::replyFinished()
{
...
void QGeoCodingManagerEngineMapbox::replyError(QGeoCodeReply::Error errorCode, const QString &errorString)
{
    QGeoCodeReply *reply = qobject_cast<QGeoCodeReply *>(sender());
    if (reply)
